...
import { QUEUE_NOTIFICATION_OFFSET } from './NotificationsConstant';
import PropTypes from 'prop-types';


export default class UspNotification extends Component {
  constructor(props) {
    super(props);
    this.state = {
      timeout: null
